...
public class RatNumTest {
  ...
  private RatNum[] ratnans =
      new RatNum[] {
        one_I_zero, negOne_I_zero, hundred_I_zero, two_I_zero, negTwo_I_zero, nine_I_zero
      };
  ...
  public void testApprox() {
    ...
    assertTrue((new Double(Double.NaN)).equals(new Double(one_I_zero.approx())));
    assertTrue((new Double(Double.NaN)).equals(new Double(negOne_I_zero.approx())));
    assertTrue((new Double(Double.NaN)).equals(new Double(two_I_zero.approx())));
    assertTrue((new Double(Double.NaN)).equals(new Double(negTwo_I_zero.approx())));
    assertTrue((new Double(Double.NaN)).equals(new Double(hundred_I_zero.approx())));
    assertTrue((new Double(Double.NaN)).equals(new Double(negOne_I_zero.approx())));

    assertTrue((new Double(Double.NaN)).equals(new Double(nine_I_zero.approx())));
