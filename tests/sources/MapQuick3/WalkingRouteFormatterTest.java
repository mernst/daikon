...
public class WalkingRouteFormatterTest {
  ...
  // JUnit calls setUp() before each test method is run
  @Before
  ...
  public void testShortDirections() throws IOException {
    ...
    assertEquals(
        "Turn left onto Penny Lane and walk for 102 minutes.\n",
        mDirections.computeDirections(mShortRoute, 180));
    assertEquals(
        "Turn right onto Penny Lane and walk for 102 minutes.\n",
        mDirections.computeDirections(mShortRoute, 0));

    assertEquals(
        "Turn slight left onto Penny Lane and walk for 102 minutes.\n",
        mDirections.computeDirections(mShortRoute, 100));
    assertEquals(
        "Turn slight right onto Penny Lane and walk for 102 minutes.\n",
        mDirections.computeDirections(mShortRoute, 80));

    assertEquals(
        "Continue onto Penny Lane and walk for 102 minutes.\n",
    ...
    assertEquals(
        "Turn sharp right onto Penny Lane and walk for 102 minutes.\n",
        mDirections.computeDirections(mShortRoute, 300));
    assertEquals(
        "Turn sharp left onto Penny Lane and walk for 102 minutes.\n",
        mDirections.computeDirections(mShortRoute, 231));

    assertEquals(
        "U-turn onto Penny Lane and walk for 102 minutes.\n",
  ...
  public void testTurning() {
    ...
    assertEquals(
        "Turn left onto Penny Lane and walk for 138 minutes.\n",
        mDirections.computeDirections(mShortRoute, 90));

    // Right turn
    mShortRoute = new Route(new GeoSegment(mName, new GeoPoint(0, 0), new GeoPoint(-oneUnit, 0)));
    assertEquals(
        "Turn right onto Penny Lane and walk for 138 minutes.\n",
        mDirections.computeDirections(mShortRoute, 90));
    ...
    assertEquals(
        "Turn slight left onto Penny Lane and walk for 40 minutes.\n",
        mDirections.computeDirections(mShortRoute, 180));
    ...
    assertEquals(
        "Turn slight right onto Penny Lane and walk for 40 minutes.\n",
        mDirections.computeDirections(mShortRoute, 180));

    // Sharp left (165 degrees)
    mShortRoute = new Route(new GeoSegment(mName, new GeoPoint(0, 0), new GeoPoint(27988, 10134)));
    assertEquals(
        "Turn sharp left onto Penny Lane and walk for 40 minutes.\n",
        mDirections.computeDirections(mShortRoute, 180));

    // Sharp right (165 degrees)
    mShortRoute = new Route(new GeoSegment(mName, new GeoPoint(0, 0), new GeoPoint(27988, -10134)));
    assertEquals(
        "Turn sharp right onto Penny Lane and walk for 40 minutes.\n",
        mDirections.computeDirections(mShortRoute, 180));

    // U-turn (on the left side, 179.5 degree)
    mShortRoute = new Route(new GeoSegment(mName, new GeoPoint(0, 0), new GeoPoint(-724368, 8542)));
    assertEquals(
        "U-turn onto Penny Lane and walk for 1000 minutes.\n",
        mDirections.computeDirections(mShortRoute, 0));
  ...
  /**
   * Test rounding distance, specifically if it rounds up to 0.1 and rounds down to 0.0. Should
   * compute time before rounding.
   */
  @Test
  public void testDistance() {
    ...
    assertEquals(
        "Continue onto Penny Lane and walk for 0 minutes.\n",
        mDirections.computeDirections(mShortRoute, 90));
  }
