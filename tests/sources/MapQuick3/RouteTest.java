...
public class RouteTest {
  ...
  /**
   * This is a helper function to make it easier to construct a Route. It takes a name and two
   * GeoPoints and creates a Route consisting of a single GeoSegment described by the arguments.
   */
  ...
  /**
   * This is a helper function that makes it easier to add to a Route. It creates a GeoSegment
   * defined by the last three arguments and adds it to the end of the Route.
   */
  ...
  public void testRoute() {
    ...
    if (!r.getStart().equals(p1)) {
      ...
      assertEquals(
          "StartHeading not set properly", r.getStartHeading(), gs.getHeading(), TOLERANCE);
      assertEquals("EndHeading not set properly", r.getEndHeading(), gs.getHeading(), TOLERANCE);
    }
  }
  ...
  protected void checkAdd(Route r, double length, GeoPoint end) {
    ...
    assertEquals(
        "Length should be " + length + " but it was " + r.getLength(),
        length,
        r.getLength(),
        TOLERANCE);
