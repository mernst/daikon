...
public class ElementaryRouteTest {
  ...
  public ElementaryRouteTest(String name) {
    super(name);
  }
  ...
  public void testImmutability() {
    ElementaryRoute rReceiver = new ElementaryRoute(new GeoSegment("West", gpDowntown, gpWest));
    ElementaryRoute rArgument = new ElementaryRoute(new GeoSegment("West", gpWest, gpWest2));
  ...
  public void testName() {
    assertTrue(
        "the name rWest is not the same than the name of the segment gsWest it was created with",
        rWest.name().equals(gsWest.name()));
  }

  public void testStart() {
    assertTrue(
        "the start point of rWest is not the same than the start point of the segment gsWest it was created with",
        rWest.start().equals(gpDowntown));
  }
  ...
  public void testEquals() {
    ...
    assertTrue(
        "rWest and rWestBis are created both from gsWest, but they are not equal",
        rWest.equals(rWestbis));
  }
  ...
  public void testAddSegment() {
    ...
    // test the spec
    assertEquals(
        "the length of rWest.addSegment(gsWest2) is not the sum of the length of rWest + gsWest2",
        r.length(),
        (rWest.length() + gsWest2.length()),
        tolerance);
    assertTrue(
        "the end point rWest.addSegment(gsWest2) is not the same end point than gsWest2",
        r.end().equals(gpWest2));
    assertTrue(
        "the start point rWest.addSegment(gsWest2) is not the same start point than rWest",
        r.start().equals(gpDowntown));
    assertEquals(
        "the end heading of rWest.addSegment(gsWest2) is not the same the heading of gsWest2",
        r.endHeading(),
        gsWest2.heading(),
        tolerance);
    assertEquals(
        "the start heading of rWest.addSegment(gsWest2) is not the same the start heading of rWest",
        r.startHeading(),
        gsWest.heading(),
        tolerance);
  ...
  public void testEquals2() {
    ...
    assertTrue(
        "r1 is created from (gpWest -> gpWest2) + (gpWest2 -> gpNorthWest2), it should not be equal to r2 created from (gpWest -> gpNorthWest2)",
        !rDW2.equals(rDWW2));
  }
  ...
  public void testElementaryRoutes() {
    ...
    if (era == null)
      ...
      fail(
          "the array of ElementaryRoute has a size bigger than 1, it should contain exactly one element");
    else
      assertTrue(
          "the array of ElementaryRoutes of the ElementaryRoute r doesn't contain r",
          era[0].equals(rWest));
  }
  ...
  public void testDirections() {
    ...
    assertEquals(
        "should be: 'Continue onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(270)
            + "'",
        "Continue onto West and go 3.0 miles.\n",
        r1.directions(270));
    assertEquals(
        "should be: 'Continue onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(279)
    ...
    assertEquals(
        "should be: 'Turn slight left onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(280)
            + "'",
        "Turn slight left onto West and go 3.0 miles.\n",
        r1.directions(280));
    assertEquals(
        "should be: 'Turn slight left onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(329)
    ...
    assertEquals(
        "should be: 'Turn slight right onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(260)
            + "'",
        "Turn slight right onto West and go 3.0 miles.\n",
        r1.directions(260));
    assertEquals(
        "should be: 'Turn slight right onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(211)
    ...
    assertEquals(
        "should be: 'Turn left onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(330)
            + "'",
        "Turn left onto West and go 3.0 miles.\n",
        r1.directions(330));
    assertEquals(
        "should be: 'Turn left onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(29)
    ...
    assertEquals(
        "should be: 'Turn right onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(210)
            + "'",
        "Turn right onto West and go 3.0 miles.\n",
        r1.directions(210));
    assertEquals(
        "should be: 'Turn right onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(151)
    ...
    assertEquals(
        "should be: 'Turn sharp left onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(30)
            + "'",
        "Turn sharp left onto West and go 3.0 miles.\n",
        r1.directions(30));
    assertEquals(
        "should be: 'Turn sharp left onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(88)
    ...
    assertEquals(
        "should be: 'Turn sharp right onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(150)
            + "'",
        "Turn sharp right onto West and go 3.0 miles.\n",
        r1.directions(150));
    assertEquals(
        "should be: 'Turn sharp right onto West and go 3.0 miles.\n' but it is: '"
            + r1.directions(92)
    ...
    assertEquals(
        "should be: 'U-turn onto West and go 3.0 miles.\n' but it is: '" + r1.directions(90) + "'",
        "U-turn onto West and go 3.0 miles.\n",
        r1.directions(90));
  }
