...
public class Instrument extends InstructionListUtils implements ClassFileTransformer {
  ...
  // /** Type for "boolean". */
  // private static final @Interned BasicType CD_boolean = Type.BOOLEAN;
  // /** Type for "byte". */
  // private static final @Interned BasicType CD_byte = Type.BYTE;
  // /** Type for "char". */
  // private static final @Interned BasicType CD_char = Type.CHAR;
  // /** Type for "double". */
  // private static final @Interned BasicType CD_double = Type.DOUBLE;
  // /** Type for "float". */
  // private static final @Interned BasicType CD_float = Type.FLOAT;
  /** Type for "int". */
  private static final @Interned BasicType CD_int = Type.INT;

  // /** Type for "long". */
  // private static final @Interned BasicType CD_long = Type.LONG;
  // /** Type for "short". */
  // private static final @Interned BasicType CD_short = Type.SHORT;
  /** Type for "void". */
  private static final @Interned BasicType CD_void = Type.VOID;
